...
//       productId: item._id,
//       quantity: item.quantity,
//       price: item.price // include price so backend can calculate totalAmount
//     }));

//     try {
//       // 1️⃣ Place order in backend
//       const orderRes = await axios.post('http://localhost:5006/api/esewa/place', {
//         fullName: address.fullName,
//         address: address.address,
//         phone: address.phone,
//         paymentMethod,
...
//       // eSewa → create POST form
//       if (paymentMethod === 'esewa') {
//         const initRes = await axios.post('http://localhost:5006/api/esewa/initiate', {
//           orderId: orderData.orderId
//         });

//         const { paymentUrl, payload } = initRes.data;
...
//         form.submit(); // Redirects to eSewa payment page
//       }
//     } catch (error) {
//       console.error('Failed to place order', error?.response?.data || error.message);
//       alert('Failed to place order. Please try again.');
...
//                 />
//                 <span className="text-gray-600">eSewa Payment</span>
//               </label>
//             </div>
//           </div>
